...
def mosaic():
    if os.path.exists('mosaic18.npy'): return np.load('mosaic18.npy'), tuple(np.load('origin18.npy'))
    ...
    np.save('mosaic18.npy',M); np.save('origin18.npy',np.array([x0,y0])); return M,(x0,y0)
